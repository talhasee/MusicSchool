...
function FeaturedCourses() {
    const featuredCourses = courseData.courses.filter(function(course:Course){
        return course.isFeatured;
    })


  return (
    <div className="py-12 px-12 bg-gray-900">
      <div>
                ...
                <div key={course.id} className="flex justify-center">
                    ...
                    >
                       <div className="p-4 sm:p-6 flex flex-col items-center text-center flex-grow">
                        ...
                        <Link href={`/coures/${course.slug}`}>Learn More</Link>
                       </div>
                    </BackgroundGradient>
                </div>
            ))}
